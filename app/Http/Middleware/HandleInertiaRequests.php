    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'flash' => [
                ...
                'whatsapp_header_media_filename' => fn () => $request->session()->get('whatsapp_header_media_filename'),
                'campaign_template_media_url' => fn () => $request->session()->get('campaign_template_media_url'),
                'campaign_template_media_filename' => fn () => $request->session()->get('campaign_template_media_filename'),
            ],
